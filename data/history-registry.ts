...
const historicalEventCatalog: HistoricalEvent[] = [
  ...
  },
  {
    ...
    era: "唐周",
    category: "宫廷权力 / 政治转折",
    summary: "病中的一夜里，奏报、守卫和脚步声一点点把局势逼近眼前。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
      "这不是神龙政变的全景回顾，而是武则天在病中度过的一个异常夜晚。她先察觉值守、奏报与近臣口风的变化，直到第二天清晨，局势已经逼到殿门之外。",
    backdropLabel: "神龙",
    backdropDescription:
      "背景占位图：病榻边的夜殿、低灯、药气与逐渐逼近的宫门动静。",
  ...
  },
  {
    ...
    era: "三国",
    category: "军阵试探",
    summary: "城门大开、琴声不乱，真正要赌的是对手会不会先被自己的怀疑绊住。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
    ...
    backdropLabel: "空城",
    backdropDescription:
      "适合做成城楼、城门与敌军逼近的现场体验，让玩家感到每一声马蹄都在逼近。",
  ...
  },
  {
    ...
    era: "东汉末",
    category: "酒局试探",
    summary: "一场看似闲谈的酒局，真正锋利的地方都藏在随口一句的试探里。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
    ...
    backdropLabel: "煮酒",
    backdropDescription:
      "适合用室内宴席、雷雨将至与低声试探的气氛，突出一场酒局里的压迫感。",
  ...
  },
  {
    ...
    era: "北宋",
    category: "宫廷权力",
    summary: "一场没有刀光的酒宴，却把最重要的兵权悄悄收回了皇帝手里。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
  ...
  },
  {
    ...
    era: "战国",
    category: "极限刺杀",
    summary: "图穷匕见之前，每一步都像礼仪；图穷匕见之后，每一步都只剩生死。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
    ...
    backdropLabel: "刺秦",
    backdropDescription:
      "适合用高阔殿前、重礼之下的紧张空气，突出一步步逼近秦王的现场感。",
  ...
  },
  {
    ...
    backdropLabel: "赛马",
    backdropDescription:
      "适合用赛马场、观赛台和终点扬尘的现场，突出每一轮出场顺序如何改变整场胜负。",
  ...
  },
  {
    ...
    era: "秦末",
    category: "军前誓师",
    summary: "锅被砸碎、船被烧断之后，所有人都知道自己已经没有回头路。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
    ...
    backdropLabel: "沉舟",
    backdropDescription:
      "适合用军营火光、锅釜碎裂与岸边断船的现场，突出决战前被逼到绝处的气氛。",
  ...
  },
  {
    ...
    era: "三国",
    category: "朝堂辩论",
    summary: "真正的胜负不在刀兵，而在朝堂上一句句话能不能把人心扳回来。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
    ...
    backdropLabel: "舌战",
    backdropDescription:
      "适合用东吴朝堂、臣列争辩和主位沉默观望的结构，突出语言交锋如何一点点改变堂上气氛。",
  ...
  },
  {
    ...
    era: "三国",
    category: "帐中生死",
    summary: "刀已经落下去，真正让人屏住呼吸的，是关羽还能不能像没事一样坐住。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
    ...
    backdropLabel: "疗毒",
    backdropDescription:
      "适合用军帐、药具与近距离疼痛感来构成现场，而不是只讲传奇故事。",
  ...
  },
  {
    ...
    era: "三国",
    category: "宫廷试压",
    summary: "殿中只给七步，曹植写出的不是才情炫技，而是用诗给自己争一条活路。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
    ...
    backdropLabel: "七步",
    backdropDescription:
      "适合用宫廷地面、脚步与逼视的静压，突出“再走几步就必须开口”的紧张。",
  ...
  },
  {
    ...
    era: "清",
    category: "公开行动",
    summary: "真正震撼人的不是一句禁烟口号，而是成箱鸦片被当众处理时那种不可回头的决心。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
    ...
    backdropLabel: "虎门",
    backdropDescription:
      "适合用海边场地、堆积的鸦片箱与公开处置的现场，突出行动感而非历史课总结。",
  ...
  },
  {
    ...
    era: "战国",
    category: "将相和解",
    summary: "门外的人背着荆条而来，真正难回答的问题不是见不见，而是怎么把这口气接住。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
    ...
    backdropLabel: "负荆",
    backdropDescription:
      "适合用府门、堂前与来人停步的短距离压力，突出两位重臣真正见面前的气氛变化。",
  ...
  },
  {
    ...
    era: "北宋",
    category: "庭院应变",
    summary: "真正的紧张只在短短几秒里：别人还在慌，司马光已经决定先砸缸救人。",
    status: "playable",
    statusLabel: "已开放试玩",
    description:
    ...
    backdropLabel: "砸缸",
    backdropDescription:
      "适合用庭院、水缸与孩子惊叫的短瞬间现场，突出应变而不是寓言式总结。",
