    ...
    return (
      <div className="px-3 py-3 md:px-5 md:py-5">
        <div className="relative min-h-[calc(100vh-8rem)] overflow-hidden rounded-[32px] border border-white/10 bg-[#090b0f] shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_16%,rgba(196,255,233,0.12),transparent_22%),radial-gradient(circle_at_20%_22%,rgba(255,255,255,0.06),transparent_28%),linear-gradient(180deg,rgba(11,13,16,0.05)_0%,rgba(11,13,16,0.24)_42%,rgba(6,7,10,0.96)_100%)]" />
